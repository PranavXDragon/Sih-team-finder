    ...
    body = `<table class="email-container" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #1a1d28; border: 1px solid rgba(255, 255, 255, 0.13); border-radius: 14px; overflow: hidden; width: 100%;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  ...
                  <h1 class="email-header-title" style="font-family: 'Archivo Black', Arial, sans-serif; font-size: 22px; color: #f7f3ea; margin: 0; line-height: 1.1; letter-spacing: -0.02em;">SIH 2026 SCET</h1>
                  <div class="email-header-subtitle" style="font-family: 'JetBrains Mono', monospace; font-size: 11px; color: #9ba2b4; margin-top: 6px; text-transform: uppercase; letter-spacing: 0.12em;">New Team Invitation</div>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td class="email-body" style="padding: 32px; color: #f7f3ea; font-size: 15px; line-height: 1.65;">
            ...
            <p style="margin: 0 0 16px; color: #f7f3ea;">{{team_leader_name}} is interested in having you join their team for <strong style="color: #c8f24d;">Smart India Hackathon 2026</strong>.</p>

            <p style="margin: 18px 0 8px; color: #f7f3ea; font-weight: 600;">Message from the Team Leader:</p>

            <!-- Quote Block -->
            <div class="quote-box" style="background-color: rgba(200, 242, 77, 0.08); border-left: 3px solid #c8f24d; border-radius: 0 8px 8px 0; padding: 14px 18px; margin: 12px 0 20px; color: #f4efe2; font-style: italic;">
              {{invite_message}}
            </div>

            <p style="margin: 0 0 16px; color: #9ba2b4;">If you are interested, you can reach out to the team leader directly to coordinate and apply.</p>
