        ...
        <div className="mbody" style={{ padding: "0 28px 32px" }}>
          ...
          <form onSubmit={handleEmail}>
            {isSignUp && (
              <div className="fld" style={{ marginBottom: 16 }}>
                <label style={{ fontSize: "13px", fontWeight: 600, color: "var(--dim)", marginBottom: 6, display: "block" }}>Full Name</label>
                <input 
                  type="text" 
                  value={name} 
          ...
          <div style={{ marginTop: 24, textAlign: "center", fontSize: "0.95rem" }}>
            ...
            <button 
              ...
              onClick={() => { setIsSignUp(!isSignUp); setErrorMsg(""); setConfirmPassword(""); setName(""); }}
              disabled={loading}
            >
